...
export default function MembershipActive({ data }) {
      ...
      <div className="flex gap-3">
        <div className="flex-1 flex gap-3 py-1">
          <div className="flex-none">
            <img src="/assets/images/member-active.png" alt="crown" className="w-10 md:w-16" />
          </div>
          <div className="flex-1">
            <div className="flex flex-col gap-1">
              <h3 className="font-semibold m-0 text-xs md:text-base">{t(data?.title)}</h3>
