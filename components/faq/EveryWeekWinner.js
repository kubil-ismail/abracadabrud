    ...
    <div className="relative bg-[#0000FF] py-8 px-4 rounded-[20px] break-words">
        <div className="flex flex-col md:grid md:grid-cols-2 md:items-center space-y-5">
            <div className="flex-0">
                <img src={`${process.env.NEXT_PUBLIC_ASSET_URL}/assets/images/wld-htp-2.png`} alt="podium-icon" className="w-full md:h-[420px]" />
            </div>
            <div className="flex-1 flex flex-col space-y-4 max-w-md md:m-auto">
            ...
            <div className="flex flex-col space-y-3">
                <span className="text-center text-slate-50 font-normal text-lg">{t('The weekly lucky draw winner!')}</span>
            ...
            <div className="flex flex-col space-y-3">
                <span className="text-center text-slate-50 font-normal text-lg">{t('The weekly most point winner!')}</span>
