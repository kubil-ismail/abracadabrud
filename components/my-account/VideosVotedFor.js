            ...
            <div className="flex flex-col space-y-7">
                          ...
                          <div className="flex flex-col">
                            <div className="flex space-x-1 items-center">
                              <span className="text-xs font-light">
                                <EllipsisText
                                  text={
                                    item?.video?.user?.contestant?.artist_band_name ??
                                    item?.video?.user?.firstname ??
                                    'Unknown'
                                  }
                                  length={10}
                                />
                            ...
                            <h3 className="font-bold text-base">
                              <EllipsisText
                                text={item?.video?.caption ?? 'Video Caption'}
                                length={18}
                              />
                            </h3>
                          </div>
              ...
              {currentPage < dataVote?.last_page && (
                <div className="flex justify-center items-center mt-4">
                  <button
                    type="button"
                    className="px-5 md:py-3 py-2 text-gray-200 border border-zinc-700 font-medium text-base rounded-md"
                    onClick={() => {
